...
def test_akzent_bekannt_und_unbekannt():
    assert ansicht.akzent("Blockiert") == "red"
    assert ansicht.akzent("Review") == "purple"
    assert ansicht.akzent("Selbst erfundene Spalte") == "gray"
...
def test_relativzeit():
    jetzt = datetime(2026, 7, 20, 12, 0, tzinfo=timezone.utc)
    assert ansicht.relativzeit("2026-07-20T11:58:00+00:00", jetzt=jetzt) == "vor 2 Min"
    assert ansicht.relativzeit("2026-07-20T09:00:00+00:00", jetzt=jetzt) == "vor 3 Std"
    assert ansicht.relativzeit("2026-07-20T11:59:40+00:00", jetzt=jetzt) == "gerade eben"
    assert ansicht.relativzeit("2026-07-18T12:00:00+00:00", jetzt=jetzt) == "vor 2 Tagen"
...
def test_baue_ansicht_verbindet_alles():
    class FakeKarte:
        ...
        beschreibung = "Ziel: x"
        spalte = "Review"
        aktualisiert = "2026-07-20T11:00:00+00:00"
